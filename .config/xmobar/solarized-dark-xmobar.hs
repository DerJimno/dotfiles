Config { 
   ...
   , commands = 
        ...
        , sepChar =  "%"
        , alignSep = "}{"
    , template = " <fc=#d33682>%logo%</fc> | %UnsafeStdinReader% }{ <fc=#cb4b16>%pacupicon% %pacup%</fc> | <fc=#859900>%cpu%</fc> | <fc=#268bd2>%disku%</fc> | <fc=#b58900>%memory%</fc> | <fc=#d33682>%wlp2s0%</fc> | <fc=#2aa198>%date%</fc> | <fc=#dc322f>%volicon% %vol%</fc> |  <fc=#eee8d5>%kbdicon% %kbd%</fc> "
