Config { 
   ...
   , commands = 
        ...
        , sepChar =  "%"
        , alignSep = "}{"
    , template = "<icon=dark.xpm/>|  %UnsafeStdinReader% }{ <fc=#625e4c>%pacupicon% %pacup%</fc> | <fc=#f4005f>%cpu%</fc> | <fc=#98e024>%disku%</fc> | <fc=#fa8419>%memory%</fc> | <fc=#9d65ff>%wlp2s0%</fc> | <fc=#f4005f>%date%</fc> | <fc=#58d1eb>%volicon% %vol%</fc> |  <fc=#c4c5b5>%kbdicon% %kbd%</fc> "
