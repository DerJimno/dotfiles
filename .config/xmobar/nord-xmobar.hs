Config { 
   ...
   , commands = 
        ...
        , sepChar =  "%"
        , alignSep = "}{"
    , template = " <fc=#F0544C>%logo%</fc> | %UnsafeStdinReader% }{ <fc=#5e81ac>%pacupicon% %pacup%</fc> | <fc=#b48ead>%cpu%</fc> | <fc=#b48ead>%cpu-temp-icon%%cpu-temp%</fc> | <fc=#a3be8c>%disku%</fc> | <fc=#ebcb8b>%memory%</fc> | <fc=#ebcb8b>%enp34s0%</fc> | <fc=#d08770>%date%</fc> | <fc=#F0544C>%volicon%%vol%</fc> | <fc=#F0544C>%kbdicon%%kbd%</fc> "
